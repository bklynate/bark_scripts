...
def process_text_snippet(text_snippet, snippet_index):
    try:
        audio_array = generate_audio(text_snippet, history_prompt="v2/en_speaker_9")  # No await keyword here
...
for i, chunk in enumerate(text_chunks):
    print(f'Chunk {i}: {len(chunk.split())} tokens')  # Print tokens per chunk
